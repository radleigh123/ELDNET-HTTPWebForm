<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentPage.aspx.cs" Inherits="HTTPWebForm.WebForm3" %>
            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 hero-img aos-init aos-animate" data-aos="zoom-out" data-aos-delay="200">
                        ...
                        <asp:Image runat="server" ImageUrl="~/Content/images/hero-img2.png" CssClass="img-fluid animated" />
                    </div>
                </div>
            </div>
        </section>
